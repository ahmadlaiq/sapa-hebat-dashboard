  ...
  async function remove(id) {
    ...
    if (result.isConfirmed) {
      try {
        ...
        Swal.fire("Deleted!", "The Ortu has been deleted.", "success");
      } catch (e) {
